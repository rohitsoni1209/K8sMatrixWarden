...
scan_id: "scan-20260718-b206"
generated_at: "2026-07-18T02:34:03Z"
...
**Scan** `scan-20260718-b206` · **Generated** 2026-07-18T02:34:03Z · **Mode** `mock`
...
#### 30. 🟠 Privilege escalation allowed
...
#### 31. 🟠 Privilege escalation allowed
...
#### 33. 🟠 Webhook failurePolicy=Ignore
...
#### 34. 🟠 Capabilities not dropped (ALL)
...
#### 35. 🟠 Capabilities not dropped (ALL)
...
#### 36. 🟠 Capabilities not dropped (ALL)
...
#### 38. 🟠 Can delete Kubernetes events
...
#### 39. 🟠 Can delete Kubernetes events
...
| 13 | 🟠 HIGH | PSA not enforcing 'restricted' | `Namespace/production` | `kubectl label ns production pod-security.kubernetes.io/enforce=rest…` |
| 14 | 🟠 HIGH | PSA not enforcing 'restricted' | `Namespace/staging` | `kubectl label ns staging pod-security.kubernetes.io/enforce=restric…` |
| 15 | 🟠 HIGH | Host IPC namespace shared | `Pod/payment-api (production)` | `kubectl patch deployment payment-api -n production -p '{"spec": {"t…` |
...
| Key | Value |
|:--|:--|
| Scan ID | `scan-20260718-b206` |
| Generated | 2026-07-18T02:34:03Z |
