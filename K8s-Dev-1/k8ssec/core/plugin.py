...
class PluginManifest:
    ...
    def role_name(self) -> str:
        ...
        """
        return f"k8ssec-plugin-{self.name.replace('_', '-')}"
...
class PluginLoader:
    """
    Discovers and loads domain shards. Built-in shards live under `k8ssec.shards`;
    ...
    def deployment_manifest(self, *, service_account: str = "k8ssec-scanner",
                            namespace: str = "k8ssec-system",
