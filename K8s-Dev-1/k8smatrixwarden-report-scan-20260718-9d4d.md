...
scan_id: "scan-20260718-9d4d"
generated_at: "2026-07-18T02:46:40Z"
...
**Scan** `scan-20260718-9d4d` · **Generated** 2026-07-18T02:46:40Z · **Mode** `mock`
...
#### 3. 🔴 API server anonymous auth enabled
...
#### 4. 🔴 Kubernetes dashboard exposed
...
#### 5. 🔴 Kubelet anonymous auth enabled
...
#### 13. 🔴 bind/escalate/impersonate verbs
...
#### 3. 🟠 Deprecated/EOL Kubernetes version
...
#### 4. 🟠 etcd encryption not configured
...
#### 15. 🟠 Can write ConfigMaps (CoreDNS risk)
...
#### 24. 🟠 PSA not enforcing 'restricted'
...
#### 36. 🟠 Webhook failurePolicy=Ignore
...
#### 37. 🟠 Capabilities not dropped (ALL)
...
#### 38. 🟠 Capabilities not dropped (ALL)
...
#### 39. 🟠 Capabilities not dropped (ALL)
...
#### 40. 🟠 Unrecognized sidecar injection
...
#### 41. 🟠 Can delete Kubernetes events
...
#### 42. 🟠 Can delete Kubernetes events
...
| 11 | 🟠 HIGH | Namespace without NetworkPolicy | `Namespace/production` | `kubectl apply -n default -f - <<'EOF' apiVersion: networking.k8s.io…` |
| 12 | 🟠 HIGH | Namespace without NetworkPolicy | `Namespace/staging` | `kubectl apply -n default -f - <<'EOF' apiVersion: networking.k8s.io…` |
| 13 | 🟠 HIGH | Host IPC namespace shared | `Pod/payment-api (production)` | `kubectl patch deployment payment-api -n production -p '{"spec": {"t…` |
...
| Key | Value |
|:--|:--|
| Scan ID | `scan-20260718-9d4d` |
| Generated | 2026-07-18T02:46:40Z |
